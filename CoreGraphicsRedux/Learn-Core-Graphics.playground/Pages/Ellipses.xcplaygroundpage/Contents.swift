...
let rendered = renderer.image { ctx in
    ...
    let circleTopRight = CGRect(x: 500, y: 0, width: 500, height: 500)
    ctx.cgContext.fillEllipse(in: circleTopRight)
    
    UIColor.blue.setFill()
    let circleBottomLeft = CGRect(x: 0, y: 500, width: 500, height: 500)
    ctx.cgContext.fillEllipse(in: circleBottomLeft)
    
    UIColor.green.setFill()
    let circleBottomRight = CGRect(x: 500, y: 500, width: 500, height: 500)
    ctx.cgContext.fillEllipse(in: circleBottomRight)
}
